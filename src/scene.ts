...
export default class Scene {
    static sin512Cache: Int32Array = new Int32Array(512);
    static sinCosCache: Int32Array = new Int32Array(2048);
    static frustumMaxX: i32;
    static frustumMinX: i32;
    static frustumMaxY: i32;
    static frustumMinY: i32;
    static frustumFarZ: i32;
    static frustumNearZ: i32;
    static textureCountLoaded: i64;

    lastVisiblePolygonsCount: i32;
    clipNear: i32 = 5;
    clipFar3d: i32 = 1000;
    clipFar2d: i32 = 1000;
    fogZFalloff: i32 = 20;
    ...
    modelCount: i32;
    maxModelCount: i32;
    models: StaticArray<GameModel | null>;
    view: GameModel;
    raster: Int32Array;
    rampCount: i32 = 50;
    gradientBase: Int32Array;
    gradientRamps: StaticArray<Int32Array>;
    anIntArray377: Int32Array | null;
    textureCount: i32;
    textureColoursUsed: StaticArray<Int8Array> | null;
    textureColourList: StaticArray<Int32Array> | null;
    textureDimension: Int32Array | null;
    textureLoadedNumber: Int64Array | null;
    texturePixels: StaticArray<Int32Array | null> | null;
    textureBackTransparent: Int8Array | null;
    textureColours64: StaticArray<Int32Array | null> | null;
    textureColours128: StaticArray<Int32Array | null> | null;
    surface: Surface;
    scanlines: StaticArray<Scanline> | null;
    minY: i32;
    maxY: i32;
    planeX: Int32Array;
    planeY: Int32Array;
    ...
    newStart: i32;
    newEnd: i32;
    mousePickingActive: bool;
    mouseX: i32;
    mouseY: i32;
    mousePickedCount: i32;
    mousePickedMax: i32 = 100;
    mousePickedModels: StaticArray<GameModel | null>;
    ...
    constructor(
        ...
        this.gradientRamps = new StaticArray<Int32Array>(this.rampCount);

        for (let i = 0; i < this.rampCount; i += 1) {
            this.gradientRamps[i] = new Int32Array(256);
        }

        this.mousePickedModels = new StaticArray<GameModel | null>(
            this.mousePickedMax
        );

        this.mousePickedFaces = new Int32Array(this.mousePickedMax);

        this.planeX = new Int32Array(MAX_PLANE);
        this.planeY = new Int32Array(MAX_PLANE);
        this.vertexShade = new Int32Array(MAX_PLANE);
        this.vertexX = new Int32Array(MAX_PLANE);
        this.vertexY = new Int32Array(MAX_PLANE);
        this.vertexZ = new Int32Array(MAX_PLANE);

        this.clipX = (this.surface.width2 / 2) as i32;
        this.clipY = (this.surface.height2 / 2) as i32;
    ...
    static textureGradientScanline(
        ai: Int32Array,
        i: i32,
        j: i32,
        k: i32,
    ...
    static rgb(r: i32, g: i32, b: i32): i32 {
        return (
            -1 -
            ((r / 8) as i32) * 1024 -
            ((g / 8) as i32) * 32 -
    ...
    addModel(gameModel: GameModel): void {
        if (!gameModel) {
            //console.log('Warning tried to add null object!');
        }

        if (this.modelCount < this.maxModelCount) {
            this.models[this.modelCount++] = gameModel;
        }
    }

    removeModel(gameModel: GameModel): void {
    ...
    setLocalPlayer(i: i32): void {
        this.view.isLocalPlayer![i] = 1;
    }

    setSpriteTranslateX(i: i32, n: i32): void {
        this.spriteTranslateX[i] = n;
    }

    setMouseLoc(x: i32, y: i32): void {
    ...
    setBounds(
        ...
        const length = clipY + baseY;

        this.scanlines = new StaticArray<Scanline>(length);
    ...
    setFrustum(i: i32, j: i32, k: i32): void {
    ...
    render(): void {
                            ...
                            if (viewYCount == 3) {
                                ...
                                if (faceFill != COLOUR_TRANSPARENT) {
                                    ...
                                    for (
                                        ...
                                        h += gameModel.projectVertexZ![
                                            vertices[vertex]
                                        ];
                                    }

                                    polygon_1.depth =
                                        ((h / num_vertices) as i32) +
                                        gameModel.depth;
        ...
        for (let i = 0; i < this.visiblePolygonsCount; i++) {
            ...
            if (gameModel_2 == this.view) {
                ...
                let w = ((this.spriteWidth[l] << this.viewDistance) /
                    vz) as i32;
                let h = ((this.spriteHeight[l] << this.viewDistance) /
                    vz) as i32;
                ...
                this.surface._spriteClipping_from7(
                    ...
                    this.spriteId[l],
                    tx,
                    ((256 << this.viewDistance) / vz) as i32
                );
                ...
                for (let k11 = 0; k11 < l10; k11++) {
                    ...
                    if (gameModel_2.projectVertexZ![k2] >= this.clipNear) {
                        ...
                        if (gameModel_2.projectVertexZ![k9] >= this.clipNear) {
                            ...
                            this.planeX[k8] = ((i5 << this.viewDistance) /
                                this.clipNear) as i32;

                            this.planeY[k8] = ((j6 << this.viewDistance) /
                                this.clipNear) as i32;
                        ...
                        if (gameModel_2.projectVertexZ![k9] >= this.clipNear) {
                            ...
                            this.planeX[k8] = ((j5 << this.viewDistance) /
                                this.clipNear) as i32;

                            this.planeY[k8] = ((k6 << this.viewDistance) /
                                this.clipNear) as i32;
    ...
    generateScanlines(
        ...
        if (i1 == 3) {
            ...
            if (k3 != k1) {
                j13 = (((j7 - k4) << 8) / (k3 - k1)) as i32;
                j14 = (((j11 - l8) << 8) / (k3 - k1)) as i32;
            ...
            if (k2 != k1) {
                j16 = (((l5 - k4) << 8) / (k2 - k1)) as i32;
                j17 = (((j10 - l8) << 8) / (k2 - k1)) as i32;
            ...
            if (k3 != k2) {
                j19 = (((j7 - l5) << 8) / (k3 - k2)) as i32;
                j20 = (((j11 - j10) << 8) / (k3 - k2)) as i32;
            ...
            if (l4 != l1) {
                i15 = (((k10 - i6) << 8) / (l4 - l1)) as i32;
                i16 = (((k13 - k11) << 8) / (l4 - l1)) as i32;
            ...
            if (l2 != l1) {
                i18 = (((k7 - i6) << 8) / (l2 - l1)) as i32;
                i19 = (((k12 - k11) << 8) / (l2 - l1)) as i32;
            ...
            if (l3 != l2) {
                i21 = (((i9 - k7) << 8) / (l3 - l2)) as i32;
                i22 = (((i13 - k12) << 8) / (l3 - l2)) as i32;
            ...
            if (l4 != l3) {
                i23 = (((k10 - i9) << 8) / (l4 - l3)) as i32;
                k23 = (((k13 - i13) << 8) / (l4 - l3)) as i32;
            ...
            if (i3 < i4) {
                let i5 = ai[0] << 8;
                let j6 = (((ai[j2] - ai[0]) << 8) / (i4 - i3)) as i32;
                let l7 = ai2[0] << 8;
                let j9 = (((ai2[j2] - ai2[0]) << 8) / (i4 - i3)) as i32;
                ...
                let j5 = ai[j2] << 8;
                let k6 = (((ai[0] - ai[j2]) << 8) / (i3 - i4)) as i32;
                let i8 = ai2[j2] << 8;
                let k9 = (((ai2[0] - ai2[j2]) << 8) / (i3 - i4)) as i32;
            ...
            for (k = 0; k < j2; k++) {
                ...
                if (j3 < j4) {
                    let l6 = ai[k] << 8;
                    let j8 = (((ai[k5] - ai[k]) << 8) / (j4 - j3)) as i32;
                    let l9 = ai2[k] << 8;
                    let l10 = (((ai2[k5] - ai2[k]) << 8) / (j4 - j3)) as i32;
                    ...
                    let i7 = ai[k5] << 8;
                    let k8 = (((ai[k] - ai[k5]) << 8) / (j3 - j4)) as i32;
                    let i10 = ai2[k5] << 8;
                    let i11 = (((ai2[k] - ai2[k5]) << 8) / (j3 - j4)) as i32;
    ...
    rasterize(
        ...
        if (l >= 0) {
            ...
            if (this.textureDimension![l] == 1) {
                ...
                if (gameModel.textureTranslucent) {
                    for (i = this.minY; i < this.maxY; i += byte1) {
                        ...
                        if (k20 <= 0) {
                            ...
                            let k23 = ((scanline_3.endS - i22) / k20) as i32;
                ...
                if (!this.textureBackTransparent![l]) {
                    for (i = this.minY; i < this.maxY; i += byte1) {
                        ...
                        if (l20 <= 0) {
                            ...
                            let l23 = ((scanline_4.endS - j22) / l20) as i32;
                ...
                for (i = this.minY; i < this.maxY; i += byte1) {
                    ...
                    if (i21 <= 0) {
                        ...
                        let i24 = ((scanline_5.endS - k22) / i21) as i32;
            ...
            if (gameModel.textureTranslucent) {
                for (i = this.minY; i < this.maxY; i += byte2) {
                    ...
                    if (j21 <= 0) {
                        ...
                        let j24 = ((scanline_6.endS - l22) / j21) as i32;
            ...
            if (!this.textureBackTransparent![l]) {
                for (i = this.minY; i < this.maxY; i += byte2) {
                    ...
                    if (k21 <= 0) {
                        ...
                        let k24 = ((scanline_7.endS - i23) / k21) as i32;
            ...
            for (i = this.minY; i < this.maxY; i += byte2) {
                ...
                if (l21 <= 0) {
                    ...
                    let l24 = ((scanline.endS - j23) / l21) as i32;
        ...
        for (let j1 = 0; j1 < this.rampCount; j1++) {
            ...
            if (j1 == this.rampCount - 1) {
                let l1 = (Math.random() * this.rampCount) as i32;
                ...
                for (let j4 = 0; j4 < 256; j4++) {
                    let j6 = j4 * j4;
                    let k7 = ((k2 * j6) / 0x10000) as i32;
                    let l8 = ((j3 * j6) / 0x10000) as i32;
                    let j10 = ((l3 * j6) / 0x10000) as i32;
        ...
        if (gameModel.transparent) {
            for (i = this.minY; i < this.maxY; i += byte0) {
                ...
                if (k6 <= 0) {
                    ...
                    let i9 = ((scanline.endS - l7) / k6) as i32;
        ...
        if (this.wideBand) {
            for (i = this.minY; i < this.maxY; i += byte0) {
                ...
                if (l6 <= 0) {
                    ...
                    let j9 = ((scanline_1.endS - i8) / l6) as i32;
        ...
        for (i = this.minY; i < this.maxY; i += byte0) {
            ...
            if (i7 <= 0) {
                ...
                let k9 = ((scanline_2.endS - j8) / i7) as i32;
    ...
    initialisePolygon3D(i: i32): void {
        ...
        if (faceCameraNormalScale == -1) {
            ...
            gameModel.normalMagnitude![face] = (this.normalMagnitude *
                Math.sqrt(t1 * t1 + t2 * t2 + t3 * t3)) as i32;
        } else {
    ...
    separatePolygon(polygon: Polygon, polygon_1: Polygon): bool {
    ...
    heuristicPolygon(polygon: Polygon, polygon_1: Polygon): bool {
        let gameModel = polygon.model!;
        let gameModel_1 = polygon_1.model!;
        let i = polygon.face;
        let j = polygon_1.face;
    ...
    allocateTextures(count: i32, something7: i32, something11: i32): void {
        this.textureCount = count;
        this.textureColoursUsed = new StaticArray<Int8Array>(count);
        this.textureColourList = new StaticArray<Int32Array>(count);
        this.textureDimension = new Int32Array(count);
        this.textureLoadedNumber = new Int64Array(count);
        this.textureBackTransparent = new Int8Array(count);
        this.texturePixels = new StaticArray<Int32Array | null>(count);

        Scene.textureCountLoaded = 0;

        for (let i = 0; i < count; i += 1) {
            this.textureLoadedNumber![i] = 0;
        }

        // 64x64 rgba
        this.textureColours64 = new StaticArray<Int32Array | null>(something7);

        // 128x128 rgba
        this.textureColours128 = new StaticArray<Int32Array | null>(
            something11
        );
    }
    ...
    prepareTexture(id: i32): void {
        if (id < 0) {
            return;
        }

        Scene.textureCountLoaded += 1;
        ...
        if (this.textureDimension![id] == 0) {
            ...
            for (let k1 = 0; k1 < this.textureCount; k1++) {
                if (
                    ...
                    this.texturePixels![k1] &&
                    this.textureLoadedNumber![k1] < GIGALONG
                ) {
        ...
        for (let k = 0; k < this.textureColours128!.length; k++) {
            if (!this.textureColours128![k]) {
                this.textureColours128![k] = new Int32Array(65536);
        ...
        for (let i2 = 0; i2 < this.textureCount; i2++) {
            if (
                ...
                this.texturePixels![i2] &&
                this.textureLoadedNumber![i2] < GIGALONG
            ) {
    ...
    setTexturePixels(id: i32): void {
        ...
        for (let i = 0; i < colourCount; i++) {
            ...
            colours![colourCount + i] = (colour - (colour >>> 3)) & 0xf8f8ff;

            colours![colourCount * 2 + i] =
                (colour - (colour >>> 2)) & 0xf8f8ff;

            colours![colourCount * 3 + i] =
                (colour - (colour >>> 2) - (colour >>> 3)) & 0xf8f8ff;
        }
    }

    scrollTexture(id: i32): void {
        if (!this.texturePixels![id]) {
            return;
        }
    ...
    method302(id: i32): i32 {
        if (id == COLOUR_TRANSPARENT) {
            return 0;
        }
    ...
    _setLight_from3(x: i32, y: i32, z: i32): void {
        ...
        for (let i = 0; i < this.modelCount; i++) {
            this.models[i]!._setLight_from3(x, y, z);
        }
    }

    _setLight_from5(ambiance: i32, diffuse: i32, x: i32, y: i32, z: i32): void {
        if (x == 0 && y == 0 && z == 0) {
            x = 32;
        }

        for (let i = 0; i < this.modelCount; i++) {
            this.models[i]!._setLight_from5(ambiance, diffuse, x, y, z);
        }
    }

    method306(i: i32, j: i32, k: i32, l: i32, i1: i32): i32 {
        if (l == j) {
            return i;
        } else {
            return i + ((((k - i) * (i1 - j)) / (l - j)) as i32);
        }
    }

    method307(i: i32, j: i32, k: i32, l: i32, flag: bool): bool {
        if ((flag && i <= k) || i < k) {
            if (i > l) {
                return true;
            }
    ...
    method308(i: i32, j: i32, k: i32, flag: bool): bool {
        if ((flag && i <= k) || i < k) {
            if (j > k) {
                return true;
            }
